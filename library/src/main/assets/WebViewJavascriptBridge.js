...
// java end will insert a var `bridgeName` here, as bellow:
...
(function() {
    ...
    function init(messageHandler) {
        if (window[bridgeName]._messageHandler) {
            throw new Error('WebViewJavascriptBridge.init called twice');
        }

        window[bridgeName]._messageHandler = messageHandler;
    ...
    function _dispatchMessageFromNative(messageJSON) {
        setTimeout(function() {
            ...
            if (message.responseId) {
                ...
                var handler = window[bridgeName]._messageHandler;
