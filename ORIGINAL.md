...
## Demo
![JsBridge Demo](https://raw.githubusercontent.com/ziv.lib/JsBridge/master/JsBridge.gif)
...
dependencies {
    compile 'com.github.ziv.lib:jsbridge:1.0.4'
}
```

## Use it in Java

add com.github.ziv.lib.jsbridge.BridgeWebView to your layout, it is inherited from WebView.
